...
import com.reflectionsinfos.repository.checks.JWTcheck;
import com.reflectionsinfos.repository.checks.SSNCheck;
...
public class HardcodedpluginRepository implements RulesDefinition, PythonCustomRuleRepository {
    ...
    new RulesDefinitionAnnotationLoader().load(repository, checkClasses().toArray(new Class[]{}));
        ...
        remediationCost.put(SSNCheck.RULE_KEY, "2min");
        remediationCost.put(JWTcheck.RULE_KEY,"3min");
    ...
    public List<Class> checkClasses() {
        return List.of(APIkeyCheck.class, AWSkeyCheck.class, SSNCheck.class, JWTcheck.class);
    }
